...
const DashboardSantri = () => {
  ...
  const [chartLabels] = useState(["KDS", "PBG", "PML", "SMG", "KBM"]);
      ...
      pie: {
        donut: {
          labels: {
            show: true,
            name: {
              // Konfigurasi label nama
              fontSize: "22px",
            },
            value: {
              // Konfigurasi label nilai
              fontSize: "16px",
            },
          },
        },
      },
    }, // Inisialisasi dengan array kosong, akan diisi dengan chartLabels
  });
    // Menambahkan total di tengah chart donut
    const totalLabel = {
      show: true,
      color: "#333", // Warna teks total
      fontSize: "24px", // Ukuran font total
      formatter: function (w) {
        // Format total sesuai kebutuhan
        const total = chartSeries.reduce((acc, val) => acc + val);
        return total.toFixed(0);
      },
    };
  
    useEffect(() => {
      // Mengatur label total di tengah chart donut
  ...
  useEffect(() => {
    // Menghancurkan DataTable sebelum menginisialisasi yang baru
  ...
  return (
    ...
    <div className="overflow-x-auto">
          <table ref={tableRef} className="rounded-sm table-auto min-w-full">
